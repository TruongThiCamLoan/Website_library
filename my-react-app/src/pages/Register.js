...
export default function RegisterForm() {
  ...
  const validateForm = () => {
    ...
    else if (username.length < 6) errs.username = "Tên đăng nhập không được nhỏ hơn 6 ký tự.";
    ...
    if (existingUsers.some(u => u.username === username)) errs.username = "Tên đăng nhập đã tồn tại.";
